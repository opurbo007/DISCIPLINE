...
const STATUS_STYLE = {
  ...
  OPEN:      { label: "Open",      cls: "text-[#009E60]  bg-[rgba(0,158,96,0.12)] border-[rgba(0,158,96,0.25)]" },
        ...
        <div>
          ...
          {pnlPreview != null && f.netPnl === "" && (
            <p className="text-[10px] font-mono text-slate-600 mt-1 flex items-center gap-1">
              ...
              <button type="button" className="text-[#009E60] underline ml-1"
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16">
        <Loader2 size={28} className="text-[#009E60] animate-spin" />
      </div>
    );
  }
                  ...
                  return (
                    <div key={setup} className="flex items-center gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                          <div
                            className={clsx("h-full rounded-full", parseInt(wr) >= 50 ? "bg-[#009E60]" : "bg-amber-500")}
                            style={{ width: `${wr}%` }}
                          />
                        </div>
                      </div>
        ...
        <div className="border-t border-white/5 px-4 py-4 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 text-xs font-mono">
            {[
              ...
              { label: "Exit Price", val: trade.exitPrice,   color: "text-[#009E60]"    },
    ...
    <div className="space-y-6">
      ...
      {trades.length > 0 && (
        <div className="flex flex-wrap gap-3">
          {[
            { label: "Open",    val: localStats.open,    color: "text-[#009E60]"  },
