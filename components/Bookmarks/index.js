      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <a
            ...
            className="text-white font-semibold text-sm hover:text-[#009E60] transition-colors truncate"
          >
            {bookmark.title}
          </a>
        ...
        <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
          <button
            ...
            className="p-1.5 rounded-md text-slate-500 hover:text-[#009E60] hover:bg-white/5 transition-colors"
            title="Edit"
          >
            <Pencil size={11} />
          </button>
