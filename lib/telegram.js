...
export const BOT_COMMANDS = [
  ...
  { command: "price", description: "Coin price: /price BTC" },
  { command: "feargreed", description: "Crypto Fear & Greed index" },
...
export const BOT_DESCRIPTION =
  "Discipline portfolio bot — link your account and check your crypto portfolio from Telegram. Try /portfolio, /price BTC, /feargreed.";

export const BOT_SHORT_DESCRIPTION = "View your Discipline portfolio from Telegram.";

export async function setBotMeta() {
  await tgApi("setMyDescription", { description: BOT_DESCRIPTION });
  await tgApi("setMyShortDescription", { short_description: BOT_SHORT_DESCRIPTION });
  return true;
}
